const { Province, City } = require("../src/api/modules/location/location.schema");
...
const addProvinces = async () => {
  try {
    ...
    if (province) {
      // @ts-ignore
      console.log("provinces are added before.".bgWhite);
      return;
    }
    ...
    // @ts-ignore
    console.log("provinces and cities are created.".magenta);
  } catch (error) {
    console.log("error in province or city creation: ", error);
  }
};

module.exports = addProvinces;
